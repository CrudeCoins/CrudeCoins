...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Tue Jan 16 14:18:42 2018
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/CrudeCoins/src/leveldb/libleveldb.a /tmp/CrudeCoins/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtNetwork -lQtCore 
AR            = ar cqs
RANLIB        = 
...
clean:compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /tmp/CrudeCoins/src/leveldb/libleveldb.a; cd /tmp/CrudeCoins/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/tmp/CrudeCoins/src/leveldb/libleveldb.a: FORCE
	cd /tmp/CrudeCoins/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -O2" libleveldb.a libmemenv.a

/tmp/CrudeCoins/build/build.h: FORCE
	cd /tmp/CrudeCoins; /bin/sh share/genbuild.sh /tmp/CrudeCoins/build/build.h
